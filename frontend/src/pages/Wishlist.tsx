            ...
            <TableWrapper>
              <thead>
                <tr>
                  ...
                  <th className="px-3 sm:px-4 py-2 text-[12px] sm:text-base ">Image</th>
                  <th className="px-3 sm:px-4 py-2 text-[12px] sm:text-base ">Name</th>
                  <th className="px-3 sm:px-4 py-2 text-[12px] sm:text-base ">
                    Stock Status
                  </th>
                  <th className="px-3 sm:px-4 py-2 text-[12px] sm:text-base ">Price</th>
                  <th className="px-3 sm:px-4 py-2 text-[12px] sm:text-base ">Action</th>
                </tr>
              </thead>
              <tbody>
                {items &&
